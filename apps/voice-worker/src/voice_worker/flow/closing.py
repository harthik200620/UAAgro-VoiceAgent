...
_FAREWELL_WORDS: frozenset[str] = frozenset(
    {
        "धन्यवाद", "धन्यबाद", "शुक्रिया", "थैंक्स", "थैंक्यू", "थैंक", "थैंकयू", "थेंक्स",
        "thanks", "thank", "thankyou", "thx", "बाय", "bye", "byebye", "अलविदा", "नमस्ते",
        "नमस्कार", "प्रणाम", "राम", "रखता", "रखती", "रखिए", "रखो", "रखूँ", "रखूं", "रखते",
        "चलता", "चलती", "चलिए", "अच्छा",
    }
)
#: Phrases that say "that is all". Matched as whole words in sequence.
_DONE_PHRASES = (
    "बस इतना ही", "इतना ही", "और कुछ नहीं", "कुछ नहीं", "बस बस", "हो गया", "हो गई",
    "काम हो गया", "बात हो गई", "फ़ोन रखता", "फोन रखता", "फ़ोन रखती", "फोन रखती",
    "फ़ोन रखो", "फोन रखो", "रख देता", "रख देती", "that's all", "thats all", "that is all",
    "nothing else", "no more", "bas", "bus", "theek hai bas",
)
...
_FILLER: frozenset[str] = frozenset(
    {
        "जी", "हाँ", "हां", "ठीक", "है", "हैं", "ओके", "ok", "okay", "अच्छा", "बहुत", "आपका",
        "आपको", "भी", "सर", "भाई", "साहब", "भैया", "चलो", "चलिए", "फिर", "तो", "अब",
        "बस", "बहुत-बहुत", "बहोत", "यू", "you", "too", "sir", "ji", "haan", "theek", "thik",
        "hai", "acha", "achha", "और", "कुछ", "नहीं", "नही", "ना", "no", "nahi", "मैं", "मै",
        "हूँ", "हूं", "फ़ोन", "फोन", "देता", "देती", "रखता", "रखती", "इतना", "ही", "काम",
        "बात", "हो", "गया", "गई", "गयी", "राम", "कर", "करता", "करती", "लेता", "लेती",
    }
)
