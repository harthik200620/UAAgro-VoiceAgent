...
_DOSAGE = _rule(
    ...
    "कितना डालें",
    "कितना डालूँ",
    # "कितना यूरिया डालूँ": the amount word, the product, then the verb.
    r"कितन[ाीे] \S+ डाल\S*",
    r"कितन[ाीे] \S+ \S+ डाल\S*",
    "कितना डालूं",
    "कितनी डालूँ",
    "कितना डालू",
    "कितना डालना है",
...
DETERMINISTIC = frozenset({Intent.SAFETY_EMERGENCY, Intent.TALK_TO_HUMAN, Intent.COMPLAINT})
